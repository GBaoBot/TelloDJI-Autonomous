...
class BrainPose_Yolov8:
    ...
    def runTestWithWebcam(self):
        ...
        while True:
            ...
            result = self.detectorPose.track(
                frame, classes=[0], conf=0.5, persist=True, verbose=False
            )[0]
    ...
    def isRaiseHand(self, obj):
        ...
        if (leftShoulder[1] != 0 and leftWrist[1] != 0 and distLeft > 5) or (
            rightShoulder[1] != 0 and rightWrist[1] != 0 and distRight > 5
        ):
            return True
        return False
