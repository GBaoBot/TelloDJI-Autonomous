...
class FollowObject():
    ...
    def __init__(self, tello, MODEL='yolov8n.pt', CONFIDENCE=0.8):

        
        # face detector
        self.dnnfacedetect = dnnobjectdetect.DnnObjectDetect(MODEL, CONFIDENCE)
    ...
    def __worker(self):
        ...
        if self.img is not None and self.cycle_counter % self.cycle_activation == 0:
            ...
            if  len(det) > 0:
                ...
                vx,dist,vy,rx = self.safety_limiter(vx,dist,vy,rx,SAFETYLIMIT=50)
